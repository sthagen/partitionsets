...
Please kindly submit issues at https://todo.sr.ht/~sthagen/partitionsets or write email to ~sthagen/partitionsets@lists.sr.ht to submit patches and request support. Thanks.
